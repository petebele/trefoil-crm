...
- [docs/specs/](docs/specs/) — specifikace modulů (vznikají PŘED stavbou; šablona [_SABLONA.md](docs/specs/_SABLONA.md)):
  [krok 2 — kostra](docs/specs/krok2-kostra.md) · [krok 3 — zákazníci](docs/specs/krok3-zakaznici.md) · [krok 4 — administrace](docs/specs/krok4-administrace.md) · [krok 5 — služby](docs/specs/krok5-sluzby-zakaznika.md) · [krok 6 — výkazy](docs/specs/krok6-vykazy-prace.md) · [Feed v1](docs/specs/feed-v1.md) · [Detail služby v1](docs/specs/sluzba-detail-v1.md) · [Nástěnka — Inbox v1](docs/specs/nastenka-inbox-v1.md) · [Notifikace v1](docs/specs/notifikace-v1.md) · [Přepínání uživatelů v1](docs/specs/prepinani-uzivatelu-v1.md) · [Komentáře v1 (návrh)](docs/specs/komentare-v1.md).
