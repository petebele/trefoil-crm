...
-------------------------------------------------------------------------------
  POZN.: Oficiální ROADMAP.md má původní číslování; SKUTEČNĚ se pořadí přeuspořádalo —
  Komunikace/Úkoly/Nástěnka se odložily a místo nich se postavily Administrace, Služby
  a Výkazy. Níže je skutečný stav.

  Krok 0 — prostředí (PC Jetel) + repo conviu-crm-2 + první push.
...
-------------------------------------------------------------------------------
  - Projekt:        D:\Internet\Trefoil CRM  (git repo „conviu-crm-2")
  ...
  - GitHub:         conviu-crm/conviu-crm-2 (private); v1 archiv conviu-crm/conviu-crm
...
-------------------------------------------------------------------------------
  ...
  - DOKONČIT REBRAND Conviu CRM → Trefoil CRM V KÓDU (dokumentace už Trefoil názvosloví
    ...
    GitHub repo conviu-crm-2 → trefoil-crm.
